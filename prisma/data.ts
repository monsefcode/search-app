...
export const fakePostsTitles = [
  "SpaceX launches another rocket into space",
  "The new Tesla Model S is going to blow your mind",
  "Neuralink just announced a breakthrough in brain-machine interfaces",
  "SpaceX is working hard to establish a sustainable colony on Mars",
  "The future is electric",
  "I just tried a prototype of the new Tesla Roadster",
  "We're living in a simulation",
  "Artificial intelligence is the future",
  "The Hyperloop is going to change transportation as we know it",
  "The boring company is digging tunnels underneath cities",
  "I just landed on the moon",
  "Mars needs memes",
  "The future of energy is solar",
  "I just had a conversation with a robot",
];
